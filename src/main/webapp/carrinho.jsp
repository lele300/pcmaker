...
<html>
    ...
    <body>
        ...
        <ul id="dropdown2" class="dropdown-content">
            ...
            <li class="divider"></li>
            <li><a class="grey darken-4 grey-text text-lighten-1" href="consultarPorId?id="><i class="material-icons left red-text text-darken-4">perm_identity</i>Meu perfil</a></li>
            <li class="divider"></li>
        </ul>
            ...
            <nav> 
                <div class="nav-wrapper grey darken-4">
                    ...
                    <ul id="nav-mobile" class="right hide-on-med-and-down grey darken-4">
                        <li class="grey-text text-lighten-1">R$ <i class="material-icons left green-text text-darken-4">attach_money</i><span class="valorTotal grey-text text-lighten-1 alinhado-esquerda">0</span></li>
                        <li class="grey-text text-lighten-1"><i class="material-icons left yellow-text text-darken-2">flash_on</i><span class="wattsConsumidos grey-text text-lighten-1 alinhado-esquerda">0</span>W</li>
        ...
        <div class="container">
            <a class="waves-effect waves-light grey darken-4 btn right btnFimCarrinho invisivel" href="pedido.jsp">Finaliza Carrinho</a>
        </div> <br>
