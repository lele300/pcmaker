...
<html>
    ...
    <body>
        ...
        <!-- Formulário Cadastro Tipo Componente -->       
                ...
                <form class="col s12" action="cadastrarTipoAtributo" method="POST">
                    <div class="row">
                        <div class="col s12">
                            ...
                            <label for="nomeTipoAtributo" class="grey-text text-darken-4"><i class="material-icons left">directions_walk</i>Nome do Atributo</label>
