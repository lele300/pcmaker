    ...
    <body>
        ...
        <main>
            <div class="container">
                ...
                <a class="waves-effect waves-light grey darken-4 btn left" href="cadastrarPedido"><i class="material-icons left">done</i>Finalizar Pedido</a>
                <a class="waves-effect waves-light grey darken-4 btn right" href="itensCarrinhoComponente"><i class="material-icons left">arrow_back</i>Voltar a comprar</a>
            </div>
