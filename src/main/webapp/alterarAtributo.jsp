...
<html>
    <head>
        ...
        <title>Alteração de Atributo</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <form class="col s12" action="alterarAtributo" method="POST">
                    
                    <% TipoAtributo tipoAtributo = (TipoAtributo) request.getAttribute("tipoAtributo"); %>
                    <div class="row">
                        
                        <div class="input-field col s12">
                            <input name="idTipoAtributo" id="idTipoAtributo" type="text" class="validate hoverable" maxlength="50" value="<%=tipoAtributo.getId()%>" hidden>
                            <input name="nomeTipoAtributo" id="nomeTipoAtributo" type="text" class="validate hoverable" maxlength="50" value="<%=tipoAtributo.getNomeAtributo()%>" required>
                            <label for="nomeTipoAtributo" class="indigo-text text-darken-4"><i class="material-icons left grey-text text-darken-4">info_outline</i>Qual atributo deseja cadastrar ?</label>
                        </div>
                    </div>
                    
                        <input type="submit" class="btn waves-effect waves-light grey darken-4" value="Alterar Atributo">
                </form>
            </div>
        </div>
