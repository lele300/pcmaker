            ...
            <div class="section no-pad-bot">
                <div class="container">
                    ...
                    <div class="row center">
                        <a href="cadastroUsuario.jsp" class="btn-large waves-effect waves-light green lighten-1 hoverable"><i class="material-icons left">subject</i>Cadastre-se agora</a>
                    </div>
                    <br><br>
